...
class ConversionOilGasIndustry:
    ...
    class Distance:
        ...
        def convert_distance(
            self, distance: float, from_unit: str, to_unit: str
        ) -> float:
            """
            ...
            conversion_factors = {
                ...
                "meters": {"feet": 3.28084, "miles": 0.000621371, "kilometers": 0.001},
                "miles": {"feet": 5280, "meters": 1609.34, "kilometers": 1.60934},
                "kilometers": {"feet": 3280.84, "meters": 1000, "miles": 0.621371},
            }
    ...
    class Volume:
        ...
        def convert_volume(self, volume: float, from_unit: str, to_unit: str) -> float:
            ...
            try:
                ...
                raise ValueError(
                    "Invalid unit. Must be one of the following: 'acre-feet', 'barrels', 'cubic feet', 'cubic meters', 'gallons', 'metric tons'."
                )
    ...
    class Pressure:
        ...
        def convert_pressure_energy(
            ...
            """
            conversion_factors = {
                "psia": {"kpa": 6.89476, "bar": 0.0689476, "BTU": None, "joules": None},
                "kpa": {"psia": 1 / 6.89476, "bar": 0.01, "btu": None, "joules": None},
                "bar": {"psia": 14.5038, "kpa": 100, "btu": None, "joules": None},
                "btu": {"psia": None, "kpa": None, "bar": None, "joules": 1055.06},
                "joules": {"psia": None, "kpa": None, "bar": None, "btu": 1 / 1055.06},
            }
