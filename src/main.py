...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.addTableWyllie.clicked.connect(lambda: self.add_table_sonic("wyllie"))
        self.addTableRaymer.clicked.connect(lambda: self.add_table_sonic("raymer"))
    ...
    def add_table_sonic(self, model):
        ...
        for i, value in enumerate(values):
            self.outputTableSonicPorosity.setItem(
                currentRowCount, i, QTableWidgetItem(str(value))
            )
    ...
    def export_table(self):
        ...
        if filename:
            ...
            data = []
            headers = [
                self.outputTableSonicPorosity.horizontalHeaderItem(i).text()
